...
{
    /// <summary>
    /// Generic configuration class for a chat service. Inheriting this class enables defining your own chat service.
    /// </summary>
    public class GenericChatServiceConfig : ScriptableObject
    {
        /// <summary>
        /// The service manager type this config should have the <see cref="ServiceFactory"/> generate
        /// </summary>
